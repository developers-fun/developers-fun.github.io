function createUnityInstance(n, o, l) {
  function s(e, r) {
    if (!s.aborted && o.showBanner)
      return "error" == r && (s.aborted = !0), o.showBanner(e, r);
    switch (r) {
      case "error":
        console.error(e);
        break;
  ...
  function t(e) {
    ...
    (n += "\n" + (o = o.startsWith(n) ? o.substring(n.length) : o).trim()) &&
      c.stackTraceRegExp &&
  ...
  for (r in (e(o, "companyName", "Unity"),
  e(o, "productName", "WebGL Player"),
  e(o, "productVersion", "1.0"),
  o))
    c[r] = o[r];
      ...
      (document.addEventListener("webkitfullscreenchange", function (e) {
        document.webkitCurrentFullScreenElement === n
          ? n.style.width &&
            ...
            (n.style.width = "100%"),
            (n.style.height = "100%"))
          : d && ((n.style.width = d), (n.style.height = u), (u = d = ""));
      }),
      {
        Module: c,
  ...
  function p(e, r) {
    if ("symbolsUrl" != e) {
      ...
      for (e in c.downloadProgress) {
        ...
        i++,
          n.lengthComputable
            ? ((o += n.loaded), (t += n.total), a++)
            : n.finished || s++;
      }
      l(0.9 * (i ? (i - s - (t ? (a * (t - o)) / t : 0)) / i : 0));
    }
  }
  function h() {
        ...
        (a.onload = function () {
          if ("undefined" == typeof unityFramework || !unityFramework) {
            ...
            for (e in r) {
              var n,
                o = r[e];
              if (c.frameworkUrl.endsWith("." + o[0]))
                return (
          ...
          (unityFramework = null), (a.onload = null), i(t);
        }),
      ...
      e = new Promise(function (r, e) {
        ...
        n.open("GET", c[o]),
          ...
          n.addEventListener("load", function (e) {
            p(o, e), r(new Uint8Array(n.response));
          }),
          n.addEventListener("error", function (e) {
            var r = "Failed to download file " + c[o];
            "file:" == location.protocol
              ? s(
                  r +
      ...
      c.addRunDependency("dataUrl"),
        e.then(function (e) {
          var r = new DataView(e.buffer, e.byteOffset, e.byteLength),
            ...
            o = "UnityWebData1.0\0";
          if (
            !String.fromCharCode.apply(null, e.subarray(n, n + o.length)) == o
          )
            throw "unknown data format";
          var t = r.getUint32((n += o.length), !0);
          for (n += 4; n < t; ) {
            var i = r.getUint32(n, !0),
              a = ((n += 4), r.getUint32(n, !0)),
  ...
  return (
    (c.SystemInfo = (function () {
      ...
      "Safari" == e && (r = a("Version/(.*?) ", t, 1)),
        "Internet Explorer" == e && (r = a("rv:(.*?)\\)? ", t, 1) || r);
      for (
        var l = [
            ["Windows (.*?)[;)]", "Windows"],
